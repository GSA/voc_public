...
(function(){
  ...
  var survey = function(opts){
    ...
    function loadSurvey() {
      ...
      var _url = "http://comment-app.hhs.gov/surveys/" + _surveyID + ".json";
      ...
      jQuery(document).on("submit", "#"+_targetID+" form", function(){
        ...
        form.attr("action", 'http://comment-app.hhs.gov/survey_responses');
        ...
        jQuery.getJSON("http://comment-app.hhs.gov/surveys/" + _surveyID + "/thank_you_page.json", "callback=?", function(data){
